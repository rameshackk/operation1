 ...
 * Custom theater playback experience wrapping YouTube embed in a luxury media frame with bilingual metadata & related rail.
 */
    ...
    <div className="fixed inset-0 z-50 flex items-center justify-center p-3 sm:p-6 md:p-8 bg-slate-950/90 backdrop-blur-xl animate-fadeIn overflow-y-auto">
      ...
      >
        ...
        <div className="flex-1 overflow-y-auto p-4 sm:p-6 space-y-6">
          ...
          {/* CUSTOM VIDEO CONTAINER WITH 16:9 THEATER FRAME */}
