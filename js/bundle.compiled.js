...
function HeroSection({
  ...
  const renderFeaturedTrack = keyPrefix => /*#__PURE__*/React.createElement("div", {
    ...
    className: "absolute bottom-0 left-0 right-0 p-3 space-y-1.5 z-10"
  }, /*#__PURE__*/React.createElement("div", {
  ...
  }, item.titleEnglish)), /*#__PURE__*/React.createElement("div", {
    className: "absolute top-0 right-0 w-px h-full bg-slate-800/60"
  }))));
  return /*#__PURE__*/React.createElement("section", {
    ...
    className: "lg:col-span-7 relative rounded-3xl overflow-hidden bg-slate-950 lg:h-[260px] border border-slate-200 dark:border-slate-800 shadow-xl select-none group/marquee"
  }, /*#__PURE__*/React.createElement("div", {
    className: "absolute top-4 left-4 z-20 flex items-center gap-2 bg-red-600 text-white font-black px-3 py-1.5 rounded-xl text-[10px] tracking-wider uppercase shadow-lg"
  }, /*#__PURE__*/React.createElement("span", {
    className: "w-2 h-2 rounded-full bg-white animate-ping"
  }), /*#__PURE__*/React.createElement("span", null, t('tickerLabel') || 'முக்கிய செய்திகள்')), /*#__PURE__*/React.createElement("div", {
    className: "h-full overflow-hidden flex items-stretch"
  }, /*#__PURE__*/React.createElement("div", {
    className: "animate-featured-marquee flex items-stretch whitespace-nowrap h-full"
